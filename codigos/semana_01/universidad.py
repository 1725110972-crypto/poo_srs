class Universidad:
    def__int__(self, logo, oferta_educativa, localidad, sistema_informatica, modalidad, servicios, ubicacion, talleres, cantidad_salones, rector)
            self.logo=logo
            self.oferta_educativa=oferta_educativa
            self.localidad=localidad
            self.sistema_informatica
            self.modalidad=modalidad
            self.servicios=servicios
            self.ubicacion=ubicacion
            self.talleres=talleres
            self.cantidad_salones
            self.rector=rector
